...
/*       Método de teste de inserção via banco direto, sem front
        ...
        Usuario usuario = new Usuario("Guilherme", "Lima",
                "Guilherme.logus@gmail.com", "teste",
    ...
    */
    ...
    public void emailCadastro(Usuario usuario){
        ...
        emailModel.setEmailTo(usuario.getUS_Email());
        emailModel.setSubject("Cadastro Realizado");
        emailModel.setText("Olá " + usuario.getUS_Nome() + ". Queremos agradecer por ter se registrado na plataforma Meu remedio");
