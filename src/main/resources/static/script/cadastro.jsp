...
//Esta funÁ„o se encarrega de trocar o idioma da p·gina
$(document).ready(function () {
        
        //id do elemento html = "#locales" (È um select)
...
function validadata() {
    ...
    if (idade < 13) {
        error.innerHTML = "Menores de 13 n√£o podem se cadastrar";
        return false;
    }
    ...
    // se for maior que 60 n√£o vai acontecer nada!
    return false;
}
